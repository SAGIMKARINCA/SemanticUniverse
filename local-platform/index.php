...
if (isset($_GET['action'])) {
    if ($_GET['action'] === 'godmode-login') {
        $_SESSION['semantic_universe_mode'] = 'godmode';
        header('Location: /SemanticUniverse/');
        exit;
    }

    if ($_GET['action'] === 'logout') {
        unset($_SESSION['semantic_universe_mode']);
        header('Location: /SemanticUniverse/');
        exit;
    }
}

$isGodMode = ($_SESSION['semantic_universe_mode'] ?? '') === 'godmode';
$godModeProfile = [
...
<body>
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-12 col-xl-4">
                            <div class="su-topbar-right">
                                <div class="su-search flex-grow-1"><?php echo $isGodMode ? 'Global arama' : 'Bos shell gorunumu'; ?></div>
                                <?php if ($isGodMode): ?>
                                    <a class="su-chip su-chip-link" href="/SemanticUniverse/?action=logout">Cikis</a>
                                <?php else: ?>
                                    <a class="su-chip su-chip-link" href="/SemanticUniverse/?action=godmode-login">God Mode Giris</a>
                                <?php endif; ?>
                                <div class="su-chip">Workspace</div>
                                <div class="su-chip"><?php echo $isGodMode ? 'Profil: ' . $godModeProfile['name'] : 'Profil'; ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid px-0">
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-12 col-xl-auto">
                            <div class="su-ribbon-badge"><?php echo $isGodMode ? 'Super Admin' : 'Public Shell'; ?></div>
                        </div>
                    </div>
                </div>
            </nav>
                    ...
                    <aside class="su-rightpanel d-none d-xl-block">
                        <?php if ($isGodMode): ?>
                            <div class="su-profile-card">
                                ...
                                <div class="su-profile-name"><?php echo $godModeProfile['name']; ?></div>
                                <div class="su-profile-meta"><?php echo $godModeProfile['role']; ?></div>
                                <div class="su-profile-meta"><?php echo $godModeProfile['scope']; ?></div>
                            </div>
                ...
                <div class="container-fluid px-0">
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-12 col-xl-3">
                            <div class="su-bottom-right text-xl-end">localhost / SemanticUniverse</div>
                        </div>
                    </div>
                </div>
            </footer>
    ...
    <script>
        (function () {
            ...
            const openSettingsButton = document.querySelector('[data-open-settings-panel]');
            const scrollMap = {
